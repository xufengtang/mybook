...
import cn.ewb.cq.framework.form.PwdForm;
import cn.ewb.cq.framework.model.PwdModel;

public class PwdAction extends Action {
	private PwdModel pwdModel = new PwdModel();
	private static Logger logger = Logger.getLogger(PwdAction.class);
	@Override
	public ActionForward execute(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		final String methodName = "pwdChange()";
